    ...
    public class Subasta : Publicacion
    {
        ...
        public List<Oferta> CrearListaDeOfertas()
        {
            ...
            while (contadorRandom < 3)
            {
                ...
                contadorRandom++;
                Oferta ofertaEnCamino = ObtenerOfertaPorId(idAleatorio);
                if (ofertaEnCamino != null)
                {
                    aux.Add(ofertaEnCamino);
